...
const Hero = () => {
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative z-20 w-full h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-20 md:py-12 flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center md:mt-20 ">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed mb-12 md:mb-16 max-w-xl mx-auto lg:mx-0">
