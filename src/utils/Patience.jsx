  ...
  return (
    <>
      ...
      >
        ...
        <br />
        • Friendship relationship<br />• Boyfriend/girl-friend relationship<br />• Course mate relationship<br />• Co-worker relationship<br />• Courtship relationship<br />• Marital relationship<br />
        ...
        <br />
        Patience can be traced to the following sources<br />• Wisdom: "A man's wisdom gives him patience; it is to his glory to overlook an offence (Proverbs 19:11). A patient person overlooks offences. This is an area where the ability of a patient person lies. A man or a woman who has wisdom does not lack patience.<br />• The Spirit: "But the fruit of the spirit is love, joy, peace, patience, kindness, goodness, gentleness, faithfulness and self-control (Galatians 5:22 - 23). Sequel to being born again is the infilling of the Holy Spirit. A child of God means a believer in Christ, who is filled with the Holy Spirit should automatically manifest the fruit of the spirit. This implies that such a person should spiritually be patient with people, especially with whoever they are in courtship or marital relationship with.<br />• Hereditary: Patience could be inherited from parents. Some people are naturally patient though they are not born again. Perhaps they inherited it from their parents.<br />• Experience: Impatience may teach one to be patient. The impatience of the Tortoise made it have a bar head. He poured hot porridge into its cap and covered its head with it. Hence, it's bar head.
        <br /><br />
        <Text fontWeight="bold" fontSize="15px">
          Benefits of Patience in Courtship
        </Text>
        <br />
        These benefits also explain the reasons for patience in a relationship. At times people may take one's patience for stupidity. A proverb says "Yiyo ekun ti ojo ko". However, it is generally believed that "Suuru lere", patience has been gained. Let's examine some benefits of patience.<br />• Understanding: "A patient man has great understanding, but a quick-tempered man displays folly". A patient person takes time to study and understand situations before acting. Hence, he behaves wisely.<br />• A patient person calms quarrels: "A hot-tempered man stirs up dissension, but a patient man calms quarrels (Proverbs 15:18). The ability to calm quarrels brings peace and a strong relationship whether courtship or marital.<br />• A patient person achieves better things: "Better a patient man (person) than a warrior, a man who controls his temper than one who takes a city" (Proverbs 16:32). "Wisdom is better than weapons of war" (Ecclesiastes 9:18). Wisdom gives patience". Although one who practices patience and self-control receives far less attention and acclaim than a warrior who takes a city, a patient man accomplishes better things". This is very true. Patience is a must-have for everybody, especially those who are Christians and are in a relationship. Better things such as (1) a peaceful, strong and sustainable relationship, (2) winning against hot-temperedness, (3) acquisition of wealth, etc. A person who possesses patience possesses everything.<br />• A patient person (man) has good self-control. It takes a man who possesses good self-control to calm quarrels (Proverbs 15:18). "A fool shows his annoyance at once a prudent man overlooks an insult" (Proverbs 12:16). Other benefits are: • A patient person makes a hard situation or things soft and easy to handle.<br />• A patient person keeps a peaceful and sustainable relationship.<br />• A patient person is protected from trouble and problems that may ensue through impatience. "Patience is bitter but its fruits are sweet". Yes! It is not easy to be patient but a patient person enjoys the above benefits and many more.
        <br /><br />
        <Text fontWeight="bold" fontSize="15px">
          Conclusion
        </Text>
